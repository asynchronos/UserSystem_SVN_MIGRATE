...
namespace aspx.manage
{
    public partial class EditUser : MyPageClass
    {
        ...
        {
            return (DropDownList)FV.FindControl("DDL_RoleCategory");
        }
        #endregion
        ...
        {
            return (Button)FV.FindControl("Butt_CancelEdit");
        }

        protected Button Butt_SaveRole()
        {
            return (Button)FV.FindControl("Butt_SaveRole");
        }

        protected Button Butt_CancelRole()
        {
            return (Button)FV.FindControl("Butt_CancelRole");
        }
        #endregion
        ...
        {
            return (ListBox)FV.FindControl("ListBox_NotSelectedRole");
        }
        protected ListBox ListBox_SelectedRole()
        {
            return (ListBox)FV.FindControl("ListBox_SelectedRole");
        }
        #endregion
        ...
        {
            return (SqlDataSource)FV.FindControl("DS_SelectedRole");
        }
        #endregion
        ...
        {
            e.Command.Parameters["@empId"].Value = ((HiddenField)FV.FindControl("EMP_ID_HF")).Value;
