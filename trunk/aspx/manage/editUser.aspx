                                                ...
                                                <EditItemTemplate>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="LAST_CHANGE_PASS_DATETextBox" runat="server" Text='<%# Eval("LAST_CHANGE_PASS_DATE", "{0:dd/MM/yyyy HH:mm:ss}") %>'
                                                                    Enabled="False" />
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:TextBox ID="UPDATE_DATETextBox" runat="server" Text='<%# Eval("UPDATE_DATE", "{0:dd/MM/yyyy HH:mm:ss}") %>'
                                                                    Enabled="False" />
                                                            </td>
                                                            <td>
                                                                &nbsp;
                                ...
                                <tr valign="top">
                                    <td height="100%" class="userDetailsWithFontSize">
                                        <div style="vertical-align: top;" id="RoleDiv">
                                            <asp:FormView ID="FV" runat="server" DataSourceID="EmpSqlDS" DataKeyNames="EMP_ID"
                                                Width="100%">
                                                <EditItemTemplate>
                                                        ...
                                                        <tr id="Table_Roles_R3">
                                                            ...
                                                            <td id="Table_Roles_R3_C3">
                                                                ...
                                                                <asp:SqlDataSource ID="DS_SelectedRole" runat="server" ConnectionString="<%$ ConnectionStrings:USERConnectionString %>"
                                                                    ...
                                                                    UpdateCommand="P_UpdateSelectedRole" UpdateCommandType="StoredProcedure" OnUpdating="DS_SelectedRole_Updating">
                                                                    <SelectParameters>
                                                                        <asp:QueryStringParameter Name="empId" QueryStringField="empId" Type="String" />
                                                                        <asp:ControlParameter ControlID="DDL_RoleCategory" Name="categoryKey" PropertyName="SelectedValue"
                                                                            Type="Int32" />
