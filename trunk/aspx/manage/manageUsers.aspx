<%@ Page Title="Manage Users" Language="C#" MasterPageFile="~/master/MasterPage.master" AutoEventWireup="true"
                ...
                <td>
                    <asp:GridView ID="UsersGV" runat="server" AutoGenerateColumns="False" DataSourceID="UsersSqlDS"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="EditUser_LinkButt" runat="server" PostBackUrl='<%# "~/aspx/manage/editUser.aspx" + "?empId=" + Eval("EMP_ID") + "&mode=edit" %>'>Edit User&Roles</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    ...
                    <asp:SqlDataSource ID="UsersSqlDS" runat="server" ConnectionString="<%$ ConnectionStrings:USERConnectionString %>"
                        SelectCommand="P_GetUsersByEmpIdFilter" SelectCommandType="StoredProcedure" OnSelecting="UsersSqlDS_Selecting">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="FilterTextBox" Name="filterValue" PropertyName="Text"
                                Type="String" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="AllUserSqlDS" runat="server" ConnectionString="<%$ ConnectionStrings:USERConnectionString %>"
                        SelectCommand="P_GetAllUsers" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </td>
            </tr>
            <tr>
                <td align="left">
                    <asp:LinkButton ID="CreateNewUser_LinkButt" runat="server" PostBackUrl="~/aspx/manage/editUser.aspx?mode=create">Create new user</asp:LinkButton>
                </td>
            </tr>
        </table>
    </div>
