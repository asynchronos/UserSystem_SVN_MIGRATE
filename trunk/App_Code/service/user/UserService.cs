...
namespace service.user
{
    ...
    public class UserService : IUserService
    {
        ...
        public int updateUserActivity(string empId, int appKey, string activity, DateTime activityDate)
        {
            int result = 0;
            ...
            using (SqlConnection myConn = new SqlConnection(ConfigurationManager.ConnectionStrings["USERConnectionString"].ConnectionString))
            {
                ...
                myCommand.Parameters.AddWithValue("@appKey", appKey);
                myCommand.Parameters.AddWithValue("@activity", activity);
                myCommand.Parameters.AddWithValue("@activityDate", activityDate);
