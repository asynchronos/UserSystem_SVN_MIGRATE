...
public partial class ListDetails : System.Web.UI.Page {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        // Add by big(24 Aug 2009)
        MetaColumn outColumn;
        bool a = table.TryGetColumn("DEL_FLAG", out outColumn);

        //ถ้ามี column DEL_FLAG ใน table ไม่ต้องสร้างปุ่ม delete
        if (outColumn != null)
        {
            GridView1.AutoGenerateDeleteButton = false;
            DetailsView1.AutoGenerateDeleteButton = false;
        }
        // End add by big(24 Aug 2009)
    }
